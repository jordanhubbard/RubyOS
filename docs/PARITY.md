...
| GUI API | SDL-compatible surfaces, events, images, fonts, menus, scrolling, resizing, drag/drop, clipboard | Ruby `Surface`, owned SDL_ttf `Font`, focusable widgets, bounded labels, caret-aware multiline editing, wheel-scrollable lists and text, declarative edge anchors, resizable windows, meters, app menus, and keyboard/pointer dispatch | In progress |
| Desktop | compositor, windows, app-aware menu bar, dynamic dock, wallpaper, shortcuts, context menus | Ruby compositor with focus/z-order, close/minimize/drag/resize, responsive anchored windows, app-aware menus, configurable global shortcuts, wallpaper, status bar, dock, and catalog launcher | In progress |
...
- context menus, clipboard, drag/drop, host file transfer, shortcut
...
2. Close the remaining shared desktop primitives before multiplying bespoke
   apps: shortcut persistence, context menus, drag/drop, host file transfer,
   and clipboard.
