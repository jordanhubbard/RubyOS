...
| GUI API | SDL-compatible surfaces, events, images, fonts, menus, scrolling, resizing, drag/drop, clipboard | Ruby `Surface`, owned SDL_ttf `Font`, focusable widgets, bounded labels, caret-aware multiline editing, wheel-scrollable lists and text, meters, app menus, and keyboard/pointer dispatch | In progress |
...
- context menus, resizing, clipboard, drag/drop, host file transfer, shortcut
  persistence, and broader source-opening workflows;
...
2. Close the remaining shared desktop primitives before multiplying bespoke
   apps: resize/layout, shortcut persistence, context menus, drag/drop, host
