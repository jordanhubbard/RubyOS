...
| Network | VirtIO net, Ethernet, ARP, IPv4, ICMP, UDP, TCP, DHCP, DNS | bare-metal Ruby VirtIO net, ARP, IPv4/ICMP echo plus UDP codec | Partial |
...
ext2 deletion and full block traversal; TCP, DHCP, DNS, and TCP REPL; input and compositor; apps;
